...
func _ready() -> void:
	...
	line_drawers.setup(raw_vertices.vertex_end_positions, cube_scene.get_node("MainCube").mesh.surface_get_arrays(0)[ArrayMesh.ARRAY_INDEX], raw_vertices.culled_indices)
